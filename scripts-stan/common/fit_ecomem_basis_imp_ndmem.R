...
#   N_dmem = 1
# } else if ((include_outbreak == 0) & (include_fire == 1)){
#   dmem = matrix(fire, ncol=1)
#   N_dmem = 1
# } else if ((include_outbreak == 1) & (include_fire == 1)){
#   dmem = matrix(cbind(fire, insect))
#   N_dmem = 2
# }# else if  ((include_outbreak == 0) & (include_fire == 0)){
# #  print("Not ready to")
# #}
